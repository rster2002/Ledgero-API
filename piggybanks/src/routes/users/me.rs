...
pub async fn get_me_info(
    ...
    resolve_user_by_id(pool, &user.uuid)
        .await
}
...
pub async fn update_me_info(
    ...
    resolve_update_user_info(pool, &user.uuid, &AdminUserInfoDto {
...
pub async fn update_me_password(
    ...
    resolve_update_user_password(pool, &user.uuid, &AdminUpdateUserPasswordDto {
...
pub async fn delete_me(
    ...
    resolve_delete_user(pool, &user.uuid)
        .await
}
